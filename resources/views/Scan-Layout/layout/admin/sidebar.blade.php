 ...
 <div id="sidebar-scrollbar">
    <nav class="iq-sidebar-menu">
        <ul id="iq-sidebar-toggle" class="iq-menu">
            ...
            <li class="{{ request()->routeIs('Scan-Layout.admin.dashboard') ? 'active' : '' }}">
                <a href="{{route('Scan-Layout.admin.dashboard')}}" class="iq-waves-effect" aria-expanded="false">
                    <i class="mdi mdi-qrcode"></i><span>Scan</span>
                </a>
            </li>
