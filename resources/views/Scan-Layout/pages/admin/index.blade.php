...
<div class="row">
    ...
    <div class="content-wrapper">
      ...
      <a href="{{route('Scan-Layout.admin.scan.add')}}" class="btn btn-primary mb-3"><i class="mdi mdi-plus"></i>New Scan</a>
      <a href="{{route('Scan-Layout.admin.scan.export')}}" class="btn btn-success mb-3"><i class="mdi mdi-export"></i>Export</a>
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <div class="modal fade" id="deleteModal-{{ $d->id }}" data-backdrop="false" tabindex="-1" aria-labelledby="deleteModalLabel-{{ $d->id }}" aria-hidden="true">
                      <div class="modal-dialog">
                          <div class="modal-content">
                              <form action="{{route('Scan-Layout.admin.scan.delete',$d->id)}}" method="POST">
                                  @csrf
                                  @method('DELETE')
                    ...
                    <div class="modal fade" id="editModal-{{ $d->id }}" data-backdrop="false" tabindex="-1" aria-labelledby="editModalLabel-{{ $d->id }}" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <form action="{{ route('Scan-Layout.admin.scan.update', $d->id) }}" enctype="multipart/form-data" method="POST">
                                    @csrf
                                    @method('PUT')
                                    <div class="modal-header">
