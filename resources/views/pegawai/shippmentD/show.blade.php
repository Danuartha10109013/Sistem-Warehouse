        ...
        <div class="col-sm-12 col-lg-12">
            <div class="save d-flex justify-content-between align-items-center mb-3">
                ...
                <div class="iq-card-body d-flex justify-content-between align-items-center">
                    @if (Auth::user()->role == 0)
                    <a href="{{route('Ship-Mark.admin.shipment-d-print', $type)}}" class="text-right mb-2 btn btn-success">Print All in This Collection</a>
                    <form class="form-inline" method="GET" action="{{route('Ship-Mark.admin.shipment-d-show',$id)}}">
                    @else
                    <a href="{{route('Ship-Mark.pegawai.shipment-d-print', $type)}}" class="text-right mb-2 btn btn-success">Print All in This Collection</a>
                    <form class="form-inline" method="GET" action="{{route('Ship-Mark.pegawai.shipment-d-show',$id)}}">
                    @endif
