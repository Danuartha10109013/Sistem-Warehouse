...
@endphp
  ...
  <table>
    ...
    <tbody>
      ...
      <tr><td align="center">3</td><td>Kondisi Kemasan Bagus</td><td style="vertical-align: middle;" align="center">{{ $baikOk }}</td><td style="vertical-align: middle;" align="center">{{ $baikNo }}</td><td>{{ $submission->keterangan2 ?? '' }}</td></tr>
