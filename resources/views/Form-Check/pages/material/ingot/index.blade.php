...
<div class="col-md-12 container-fluid">
    <div class="content-wrapper">
      ...
      <div class="d-flex justify-content-between align-items-center mb-3">
        <div class="d-flex">
            <a href="{{ Auth::user()->role == 0 ? route('Form-Check.admin.ingot.add') : route('Form-Check.pegawai.ingot.add') }}"
               class="btn btn-primary mr-2" style="text-decoration: none; font-size: 15px">Tambahkan response</a>
            <a href="{{ route('Form-Check.admin.ingot.export') }}"
               class="btn btn-success" style="text-decoration: none; font-size: 15px">Export Excel</a>
        </div>

        <form action="{{ route('Form-Check.admin.ingot') }}" method="GET" class="ml-2" style="display: inline;">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                          @if (Auth::user()->role == 0)
                          <div class="d-flex">
                            <a href="{{route('Form-Check.admin.ingot.print', $d->id)}}" class="me-2">
                                <button class="btn btn-success">Print</button>
                            </a>
                            <a href="{{route('Form-Check.admin.ingot.show', $d->id)}}" class="me-2">
                            ...
                            document.querySelectorAll('.delete-button').forEach(button => {
                              button.addEventListener('click', function() {
                                  ...
                                  const action = `{{ route('Form-Check.admin.ingot.destroy', ':id') }}`.replace(':id', id);
                           ...
                           @else
                           <a href="{{route('Form-Check.pegawai.ingot.print', $d->id)}}"> <label class="btn btn-success">print</label></a>
                          @endif
                        </td>
                    </tr>
                    @endforeach
