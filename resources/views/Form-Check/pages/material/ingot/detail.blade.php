            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="col-md-12">
                        ...
                        @php
                            $ingot_images = \App\Models\Ingot_imageM::where('ingot_id', $submission->id)->first();
                        @endphp

                        <div class="form-group">
                            <label><strong>FOTO</strong></label>
                            <div class="row">
                                @if($ingot_images && $ingot_images->foto)
                                    @php
                                        $fotos = json_decode($ingot_images->foto, true);
                                    @endphp
                                    @if($fotos && is_array($fotos))
                                        @foreach($fotos as $fotoItem)
                                            <div class="col-md-3 mb-3">
                                                <img src="{{ asset('storage/ingot/'.$fotoItem) }}" class="img-fluid" alt="Foto">
                                            </div>
                                        @endforeach
                                    @else
                                        <p>-</p>
                        ...
                        <div class="form-group">
                            <label>Foto</label>
                            <div class="row">
                                @if($ingot_images && $ingot_images->foto1)
                                    @php
                                        $fotos1 = json_decode($ingot_images->foto1, true);
                                    @endphp
                                    @if($fotos1 && is_array($fotos1))
                                        @foreach($fotos1 as $fotoItem)
                                            <div class="col-md-3 mb-3">
                                                <img src="{{ asset('storage/ingot/'.$fotoItem) }}" class="img-fluid" alt="Foto Barang Sesuai">
                                            </div>
                                        @endforeach
                                    @else
                                        <p>-</p>
                        ...
                        <div class="form-group">
                            <label>Foto</label>
                            <div class="row">
                                @if($ingot_images && $ingot_images->foto3)
                                    @php
                                        $fotos3 = json_decode($ingot_images->foto3, true);
                                    @endphp
                                    @if($fotos3 && is_array($fotos3))
                                        @foreach($fotos3 as $fotoItem)
                                            <div class="col-md-3 mb-3">
                                                <img src="{{ asset('storage/ingot/'.$fotoItem) }}" class="img-fluid" alt="Foto Kering/Basah">
                                            </div>
                                        @endforeach
                                    @else
                                        <p>-</p>
                        ...
                        <div class="form-group">
                            <label>Foto</label>
                            <div class="row">
                                @if($ingot_images && $ingot_images->foto5)
                                    @php
                                        $fotos5 = json_decode($ingot_images->foto5, true);
                                    @endphp
                                    @if($fotos5 && is_array($fotos5))
                                        @foreach($fotos5 as $fotoItem)
                                            <div class="col-md-3 mb-3">
                                                <img src="{{ asset('storage/ingot/'.$fotoItem) }}" class="img-fluid" alt="Foto Jumlah">
                                            </div>
                                        @endforeach
                                    @else
                                        <p>-</p>
