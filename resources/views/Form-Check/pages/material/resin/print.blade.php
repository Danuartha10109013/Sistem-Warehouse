...
@endphp
  ...
  <table>
    ...
    <tbody>
      ...
      <tr><td align="center">2</td><td>Barang Sesuai Surat Jalan</td><td style="vertical-align: middle; " align="center">√</td><td></td><td></td></tr>
      ...
      <tr><td align="center">7</td><td>Drum tidak penyok / bocor (Resin - Alkali)</td><td style="vertical-align: middle; " align="center">{{$submission->drum == 'Sesuai' ? '√' : ''}}</td><td></td><td>{{$submission->keterangan6}}</td></tr>
