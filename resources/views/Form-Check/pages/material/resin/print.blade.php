  ...
  <table>
    ...
    <tbody>
      @php
          ...
          [$drumOk, $drumNo] = $markYesNo($submission->drum ?? null);
      @endphp
      ...
      <tr><td align="center">7</td><td>Drum tidak penyok / bocor (Resin - Alkali)</td><td style="vertical-align: middle;" align="center">{{ $drumOk }}</td><td style="vertical-align: middle;" align="center">{{ $drumNo }}</td><td>{{ $submission->keterangan6 ?? '' }}</td></tr>
